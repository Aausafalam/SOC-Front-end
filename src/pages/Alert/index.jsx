...
const Alert = () => {
  ...
  const { AlertList, fetchAlertList, alertDetail, fetchAlertDetail } =
    useAlert();
      ...
      <div className={Styles.content_container}>
        ...
        <div className="table-container" style={{ maxHeight: "76vh" }}>
          <table>
            ...
            <tbody>
            {alertDetail &&
          alertDetail.map((alert, alertIndex) => (
            <>
              <tr key={`alert-${alertIndex}`}>
                <td colSpan="2"><strong>Alert {alertIndex + 1}</strong></td>
              </tr>
              <tr>
                <td>Severity</td>
