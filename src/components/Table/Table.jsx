...
const TableComponent = ({ tableData, filterOptions }) => {
  ...
  const handleSuggestionClick = useCallback(
    (suggestion) => {
      ...
      fetchPageData(currentPage, itemsPerPage, sortBy, order, suggestion, selectedFilter);
      setShowSuggestions(false);
    },
    [currentPage, itemsPerPage, sortBy, order, fetchPageData, selectedFilter]
  );
