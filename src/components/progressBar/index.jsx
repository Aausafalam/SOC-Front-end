...
const ProgressBar = ({data}) => {
  ...
  return (
    <div className={styles.container}>
        <div style={{background:data.strokeColor}} className={styles.icon}>
        ...
        <div>
            ...
            <Line strokeLinecap={"round"} percent={data.value} strokeWidth={2.5} trailWidth={2.5} strokeColor={data.strokeColor} />
        </div>
